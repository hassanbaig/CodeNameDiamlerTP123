...
namespace DiamlerTP
{
    public partial class frmReportViewer : System.Web.UI.Page
    {
        ...
        public void DisplayRecord(string ID, string ReportType)
        {
            ...
            //    DataView dview = new DataView();
            //    dview.Table = ds.Tables[0];
            //    DiamlerTP.Versicherung.Insurance creport = new Versicherung.Insurance();                
            //    creport.SetDataSource(dview);
            //    CrystalReportViewer1.ReportSource = creport;
            //    CrystalReportViewer1.DataBind();
            //}
            ...
            //    DataView dview = new DataView();
            //    dview.Table = ds.Tables[0];
            //    DiamlerTP.TransportOrderRequest.Transport_Order_Address creport = new TransportOrderRequest.Transport_Order_Address();                               
            //    creport.SetDataSource(dview);
            //    CrystalReportViewer1.ReportSource = creport;
            //    CrystalReportViewer1.DataBind();
            //}
            ...
            //    DataView dview = new DataView();
            //    dview.Table = ds.Tables[0];
            //    DiamlerTP.CMR.CMR creport = new DiamlerTP.CMR.CMR();
            //    creport.SetDataSource(dview);
            //    CrystalReportViewer1.ReportSource = creport;
            //    CrystalReportViewer1.DataBind();
            //}
